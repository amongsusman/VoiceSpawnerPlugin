...
hostile_mobs = ['blaze','bogged','breeze','creeper','elder guardian','ender dragon','endermite','evoker','ghast','guardian','hoglin','husk','magma cube','phantom','piglin brute','pillager','ravager','shulker','silverfish','skeleton','skeleton horseman','slime','spider jockey','stray','vex','vindicator','warden','witch', 'which','wither','wither skeleton','zoglin','zombie','zombie villager', 'bee', 'cave spider', 'dolphin', 'drowned', 'enderman', 'goat', 'iron golem', 'llama', 'piglin', 'panda', 'polar bear', 'wolf', 'zombified piglin']
